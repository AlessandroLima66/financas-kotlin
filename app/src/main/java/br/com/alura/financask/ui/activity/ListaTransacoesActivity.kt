...
class ListaTransacoesActivity : AppCompatActivity() {
    ...
    private val viewDaActivity: View by lazy { window.decorView }
    private val viewGroupDaActivity: ViewGroup by lazy { viewDaActivity as ViewGroup }
    ...
    private fun chamaDialogDeAdicao(tipo: Tipo) {
        AdicionaTransacaoDialog(this, viewGroupDaActivity)
                .chamaDialog(tipo) { transacaoCriada ->
    ...
    private fun chamaDiologDeAlteracao(transacao: Transacao, posicao: Int) {
        AlteraTransacaoDialog(this, viewGroupDaActivity)
                .chamaDialog(transacao, delegate = { transacaoAlterada ->
